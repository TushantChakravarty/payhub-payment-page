        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end p-0 mt-3">
              ...
              <Button type="button" class="btn-outline-primary m-0" data-dismiss="modal" aria-label="Close" onClick={()=>{
                setOpenQr(true)
              }}>Show QR</Button>
            </div>
          </div>
        </div>
      <QrcodeModal open={openOr} setOpen={setOpenQr} data={data?data?.upiUrl:''}/>
      </div>
            </Modal>
